    ...
    return (
        <div className="flex flex-row">
            ...
            <div className="vacant1 flex flex-row items-center">
                <div className={(toggle ? ' l-main-year-transition ' : ' ') + " l-main-year flex flex-row items-center justify-center"}>
                    <p className={toggle ? '' : 'l-main-circle-transition'}>{props.year}</p>
                    <img className={toggle ? '' : 'l-main-circle-transition'} src={require('../../../img/techno_img.png')} />
                </div>
                
                <div className={(toggle ? " l-inc_transition " : " ") + " content-discription1 flex flex-col items-end p-2"}>
