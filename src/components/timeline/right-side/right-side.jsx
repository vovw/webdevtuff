  ...
  return (
    <div className="R-3 flex flex-row">
      <div className="vacant2 flex flex-row items-center">
        <div
          className={
            (toggle ? "r-main-year-transition " : "") +
            " r-main-year flex flex-row items-center justify-center"
          }
        >
          <img
            className={toggle ? "r-main-circle-transition " : ""}
            src={require("../../../img/techno_img.png")}
          />
          <p className={toggle ? "r-main-circle-transition " : ""}>
            {props.year}
          </p>
        </div>
        <div
          className={
            (toggle ? "r-inc_transition" : " ") +
            " content-discription2 flex flex-col items-start p-2"
          }
        >
